...
+function(a) {
    ...
    }
    {
        var c = function(a, b, c) {
            ...
            var c = "alert", f = "4.0.0", g = "bs.alert", h = "." + g, i = ".data-api", j = a.fn[c], k = 150, l = {
                ...
                return d(c, [ {
                    ...
                    key: "_getRootElement",
                    value: function(b) {
                        var c = e.getSelectorFromElement(b), d = !1;
            ...
            return a(document).on(m.CLICK_DATA_API, l.DISMISS, o._handleDismiss(new o())), a.fn[c] = o._jQueryInterface, 
            a.fn[c].Constructor = o, a.fn[c].noConflict = function() {
                return a.fn[c] = j, o._jQueryInterface;
            }, o;
        }(jQuery), function(a) {
            var c = "button", e = "4.0.0", f = "bs.button", g = "." + f, h = ".data-api", i = a.fn[c], j = {
                ACTIVE: "active",
                BUTTON: "btn",
                FOCUS: "focus"
            }, k = {
            ...
            var c = "carousel", f = "4.0.0", g = "bs.carousel", h = "." + g, i = ".data-api", j = a.fn[c], k = 600, l = {
                interval: 5e3,
                keyboard: !0,
                slide: !1,
                pause: "hover",
                ...
                function i(c, d) {
                    b(this, i), this._items = null, this._interval = null, this._activeElement = null, 
                    this._isPaused = !1, this._isSliding = !1, this._config = this._getConfig(d), this._element = a(c)[0], 
                ...
                return d(i, [ {
                    ...
                    key: "pause",
                    value: function(b) {
                        b || (this._isPaused = !0), a(this._element).find(q.NEXT_PREV)[0] && e.supportsTransitionEnd() && (e.triggerTransitionEnd(this._element), 
                    ...
                    value: function(b) {
                        ...
                        this._config.interval && !this._isPaused && (this._interval = setInterval(a.proxy(this.next, this), this._config.interval));
                    }
                }, {
                    key: "to",
                    value: function(b) {
                    ...
                    key: "_slide",
                    value: function(b, c) {
                        var d = this, f = a(this._element).find(q.ACTIVE_ITEM)[0], g = c || f && this._getItemByDirection(b, f), h = Boolean(this._interval), i = b === n.NEXT ? p.LEFT : p.RIGHT;
                        ...
                        if (!j.isDefaultPrevented() && f && g) {
                            ...
                            e.supportsTransitionEnd() && a(this._element).hasClass(p.SLIDE) ? (a(g).addClass(b), 
                            e.reflow(g), a(f).addClass(i), a(g).addClass(i), a(f).one(e.TRANSITION_END, function() {
                                a(g).removeClass(i).removeClass(b), a(g).addClass(p.ACTIVE), a(f).removeClass(p.ACTIVE).removeClass(b).removeClass(i), 
                                d._isSliding = !1, setTimeout(function() {
                                    return a(d._element).trigger(l);
                                }, 0);
                            }).emulateTransitionEnd(k)) : (a(f).removeClass(p.ACTIVE), a(g).addClass(p.ACTIVE), 
                    ...
                    value: function(b) {
                        return this.each(function() {
                            ...
                            c || (c = new i(this, d), a(this).data(g, c)), "number" == typeof b ? c.to(b) : e ? c[e]() : d.interval && (c.pause(), 
                            c.cycle());
                        });
                    }
                }, {
                    ...
                    value: function(b) {
                        ...
                        if (c) {
                            ...
                            if (d && a(d).hasClass(p.CAROUSEL)) {
                                var f = a.extend({}, a(d).data(), a(this).data()), h = this.getAttribute("data-slide-to");
                                h && (f.interval = !1), i._jQueryInterface.call(a(d), f), h && a(d).data(g).to(h), 
                                b.preventDefault();
                            }
                        }
                    }
            ...
            var c = "collapse", f = "4.0.0", g = "bs.collapse", h = "." + g, i = ".data-api", j = a.fn[c], k = 600, l = {
                toggle: !0,
                parent: ""
            }, m = {
                toggle: "boolean",
                ...
                function h(c, d) {
                    b(this, h), this._isTransitioning = !1, this._element = c, this._config = this._getConfig(d), 
                    this._triggerArray = a.makeArray(a('[data-toggle="collapse"][href="#' + c.id + '"],' + ('[data-toggle="collapse"][data-target="#' + c.id + '"]'))), 
                ...
                return d(h, [ {
                    ...
                    value: function() {
                        ...
                        if (!this._isTransitioning && a(this._element).hasClass(o.IN)) {
                            ...
                            if (a(this._element).trigger(c), !c.isDefaultPrevented()) {
                                var d = this._getDimension(), f = d === p.WIDTH ? "offsetWidth" : "offsetHeight";
                                this._element.style[d] = this._element[f] + "px", e.reflow(this._element), a(this._element).addClass(o.COLLAPSING).removeClass(o.COLLAPSE).removeClass(o.IN), 
                    ...
                    key: "_getConfig",
                    value: function(b) {
                        return b = a.extend({}, l, b), b.toggle = Boolean(b.toggle), e.typeCheckConfig(c, b, m), 
                        b;
                    }
                }, {
                    key: "_getDimension",
                    ...
                    value: function(b) {
                        return this.each(function() {
                            ...
                            !d && e.toggle && /show|hide/.test(b) && (e.toggle = !1), d || (d = new h(this, e), 
                            c.data(g, d)), "string" == typeof b && d[b]();
                        });
                    }
                }, {
                    key: "VERSION",
            ...
            var c = "dropdown", f = "4.0.0", g = "bs.dropdown", h = "." + g, i = ".data-api", j = a.fn[c], k = {
                HIDE: "hide" + h,
                HIDDEN: "hidden" + h,
                SHOW: "show" + h,
                SHOWN: "shown" + h,
                ...
                return d(c, [ {
                    ...
                    value: function() {
                        ...
                        var b = c._getParentFromElement(this), d = a(b).hasClass(l.OPEN);
                        ...
                        return a(b).trigger(g), g.isDefaultPrevented() ? !1 : (this.focus(), this.setAttribute("aria-expanded", "true"), 
                        a(b).toggleClass(l.OPEN), a(b).trigger(a.Event(k.SHOWN, f)), !1);
                    }
                }, {
                    key: "dispose",
                    value: function() {
                    ...
                    value: function(b) {
                        return this.each(function() {
                            var d = a(this).data(g);
                            d || a(this).data(g, d = new c(this)), "string" == typeof b && d[b].call(this);
                        });
                    }
                }, {
                    key: "_clearMenus",
                    value: function(b) {
                        if (!b || 3 !== b.which) {
                            ...
                            for (var e = a.makeArray(a(m.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                                var g = c._getParentFromElement(e[f]), h = {
                                    relatedTarget: e[f]
                                };
                    ...
                    value: function(b) {
                        var c = void 0, d = e.getSelectorFromElement(b);
                        return d && (c = a(d)[0]), c || b.parentNode;
                    }
                }, {
                    key: "_dataApiKeydownHandler",
                    value: function(b) {
                        if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName) && (b.preventDefault(), 
                        b.stopPropagation(), !this.disabled && !a(this).hasClass(l.DISABLED))) {
                            var d = c._getParentFromElement(this), e = a(d).hasClass(l.OPEN);
                            ...
                            if (g = g.filter(function(a) {
                                ...
                                38 === b.which && h > 0 && h--, 40 === b.which && h < g.length - 1 && h++, ~h || (h = 0), 
                                g[h].focus();
                            }
                        }
                    }
            ...
            var c = "modal", f = "4.0.0", g = "bs.modal", h = "." + g, i = ".data-api", j = a.fn[c], k = 300, l = 150, m = {
                backdrop: !0,
                keyboard: !0,
                focus: !0,
                show: !0
                ...
                function i(c, d) {
                    b(this, i), this._config = this._getConfig(d), this._element = c, this._dialog = a(c).find(q.DIALOG)[0], 
                ...
                return d(i, [ {
                    ...
                    key: "_showElement",
                    value: function(b) {
                        var c = this, d = e.supportsTransitionEnd() && a(this._element).hasClass(p.FADE);
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), 
                        this._element.style.display = "block", this._element.scrollTop = 0, d && e.reflow(this._element), 
                    ...
                    value: function(b, c) {
                        return this.each(function() {
                            ...
                            d || (d = new i(this, e), a(this).data(g, d)), "string" == typeof b ? d[b](c) : e.show && d.show(c);
                        });
                    }
                }, {
                    key: "VERSION",
            ...
            return a(document).on(o.CLICK_DATA_API, q.DATA_TOGGLE, function(b) {
                var c = this, d = void 0, f = e.getSelectorFromElement(this);
                f && (d = a(f)[0]);
            ...
            var c = "scrollspy", f = "4.0.0", g = "bs.scrollspy", h = "." + g, i = ".data-api", j = a.fn[c], k = {
                offset: 10,
                method: "auto",
                target: ""
            }, l = {
                ...
                function i(c, d) {
                    b(this, i), this._element = c, this._scrollElement = "BODY" === c.tagName ? window : c, 
                ...
                return d(i, [ {
                    key: "refresh",
                    value: function() {
                        var b = this, c = this._scrollElement !== this._scrollElement.window ? p.POSITION : p.OFFSET, d = "auto" === this._config.method ? c : this._config.method, f = d === p.POSITION ? this._getScrollTop() : 0;
                        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight();
                        var g = a.makeArray(a(this._selector));
                        g.map(function(b) {
                            var c = void 0, g = e.getSelectorFromElement(b);
                    ...
                    value: function(b) {
                        return this.each(function() {
                            ...
                            c || (c = new i(this, d), a(this).data(g, c)), "string" == typeof b && c[b]();
                        });
                    }
                }, {
                    key: "VERSION",
            ...
            var c = "tab", f = "4.0.0", g = "bs.tab", h = "." + g, i = ".data-api", j = a.fn[c], k = 150, l = {
                HIDE: "hide" + h,
                HIDDEN: "hidden" + h,
                SHOW: "show" + h,
                SHOWN: "shown" + h,
                ...
                return d(c, [ {
                    ...
                    value: function() {
                        ...
                        if (!this._element.parentNode || this._element.parentNode.nodeType !== Node.ELEMENT_NODE || !a(this._element).hasClass(m.ACTIVE)) {
                            var c = void 0, d = void 0, f = a(this._element).closest(n.UL)[0], g = e.getSelectorFromElement(this._element);
                    ...
                    value: function(b, c, d) {
                        var f = a(c).find(n.ACTIVE_CHILD)[0], g = d && e.supportsTransitionEnd() && (f && a(f).hasClass(m.FADE) || Boolean(a(c).find(n.FADE_CHILD)[0])), h = a.proxy(this._transitionComplete, this, b, f, g, d);
                    ...
                    value: function(b, c, d, f) {
                        ...
                        if (a(b).addClass(m.ACTIVE), b.setAttribute("aria-expanded", !0), d ? (e.reflow(b), 
                    ...
                    value: function(b) {
                        return this.each(function() {
                            var d = a(this), e = d.data(g);
                            e || (e = e = new c(this), d.data(g, e)), "string" == typeof b && e[b]();
                        });
                    }
                }, {
                    key: "VERSION",
            ...
            var c = "tooltip", f = "4.0.0", g = "bs.tooltip", h = "." + g, i = a.fn[c], j = 150, k = "bs-tether", l = {
                animation: !0,
                ...
                function i(a, c) {
                    b(this, i), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, 
                    this._tether = null, this.element = a, this.config = this._getConfig(c), this.tip = null, 
                    this._setListeners();
                }
                return d(i, [ {
                    key: "enable",
                    ...
                    value: function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            var f = this.getTipElement(), g = e.getUID(this.constructor.NAME);
                            f.setAttribute("id", g), this.element.setAttribute("aria-describedby", g), this.setContent(), 
                            this.config.animation && a(f).addClass(q.FADE);
                            var h = "function" == typeof this.config.placement ? this.config.placement.call(this, f, this.element) : this.config.placement, j = this._getAttachment(h);
                            a(f).data(this.constructor.DATA_KEY, this).appendTo(document.body), a(this.element).trigger(this.constructor.Event.INSERTED), 
                    ...
                    key: "hide",
                    value: function(b) {
                        var c = this, d = this.getTipElement(), f = a.Event(this.constructor.Event.HIDE), g = function() {
                        ...
                        a(this.element).trigger(f), f.isDefaultPrevented() || (a(d).removeClass(q.IN), e.supportsTransitionEnd() && a(this.tip).hasClass(q.FADE) ? a(d).one(e.TRANSITION_END, g).emulateTransitionEnd(j) : g(), 
                        this._hoverState = "");
                    }
                }, {
                    key: "isWithContent",
                    ...
                    key: "setContent",
                    value: function() {
                        var b = this.getTipElement(), c = this.getTitle(), d = this.config.html ? "innerHTML" : "innerText";
                        a(b).find(r.TOOLTIP_INNER)[0][d] = c, a(b).removeClass(q.FADE).removeClass(q.IN), 
                        this.cleanupTether();
                    }
                }, {
                    key: "getTitle",
                    ...
                    key: "cleanupTether",
                    value: function() {
                        this._tether && (this._tether.destroy(), a(this.element).removeClass(this._removeTetherClasses), 
                    ...
                    value: function(b) {
                        return this.each(function() {
                            var c = a(this).data(g), d = "object" == typeof b ? b : null;
                            (c || !/destroy|hide/.test(b)) && (c || (c = new i(this, d), a(this).data(g, c)), 
                            "string" == typeof b && c[b]());
                        });
                    }
                }, {
        ...
        !function(e) {
            var g = "popover", h = "4.0.0", i = "bs.popover", j = "." + i, k = e.fn[g], l = e.extend({}, f.Default, {
                placement: "right",
                trigger: "click",
                content: "",
                ...
                return a(k, f), d(k, [ {
                    ...
                    key: "setContent",
                    value: function() {
                        var a = this.getTipElement(), b = this.getTitle(), c = this._getContent(), d = e(a).find(o.TITLE)[0];
                        d && (d[this.config.html ? "innerHTML" : "innerText"] = b), e(a).find(o.CONTENT).children().detach().end()[this.config.html ? "string" == typeof c ? "html" : "append" : "text"](c), 
                        e(a).removeClass(n.FADE).removeClass(n.IN), this.cleanupTether();
                    }
                }, {
                    key: "_getContent",
                    value: function() {
                    ...
                    value: function(a) {
                        return this.each(function() {
                            var b = e(this).data(i), c = "object" == typeof a ? a : null;
                            (b || !/destroy|hide/.test(a)) && (b || (b = new k(this, c), e(this).data(i, b)), 
                            "string" == typeof a && b[a]());
                        });
                    }
                }, {
...
$(function() {
    ...
    $('body, .header-nav form[role="search"] button[type="reset"]').on("click keyup", function(event) {
        ...
        if (event.which == 27 && $('.header-nav form[role="search"]').hasClass("active") || $(event.currentTarget).attr("type") == "reset") {
            closeSearch();
        }
    });
    ...
    $(document).on("click", '.header-nav form[role="search"]:not(.active) button[type="submit"]', function(event) {
        ...
        var $form = $(this).closest("form"), $input = $form.find("input");
